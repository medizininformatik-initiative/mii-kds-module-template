...
* **[Validate an instance](validate.md)** — check your own FHIR instance against this module's profiles (online, command line, API, or a self-hosted validator; synthetic data only against the public service).
