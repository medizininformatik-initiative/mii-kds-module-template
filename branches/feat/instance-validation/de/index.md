...
* **[Instanz validieren](validate.md)** — eine eigene FHIR-Instanz gegen die Profile dieses Moduls prüfen (online, Kommandozeile, API oder ein selbst betriebener Validator; gegen den öffentlichen Dienst nur synthetische Daten).
