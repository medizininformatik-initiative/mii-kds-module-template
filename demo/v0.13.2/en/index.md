# Home - MII Implementation Guide Module Template v2027.0.0-template.0.13.2
...
| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/modul-template/ImplementationGuide/mii-ig-template | *Version*:2027.0.0-template.0.13.2 |
...
| :--- | :--- |
| Date | 2027-01-01 |
| Version | 2027.0.0-template.0.13.2 (CalVer`YYYY.n.n`) |
| Status | active |
| Realm | DE |
