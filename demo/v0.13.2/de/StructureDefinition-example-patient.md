# Example Patient — template starter - MII Implementation Guide Module Template v2027.0.0-template.0.13.2
...
| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/modul-template/StructureDefinition/example-patient | *Version*:2027.0.0-template.0.13.2 |
| Active Stand: 2026-08-31 | *Maschinenlesbarer Name*:ExamplePatient |
...
```json
{
  ...
  "meta" : {
    ...
    },
    {
      ...
      {
        "url" : "version",
        "valueString" : "2027.0.0-template.0.13.2"
      },
      {
        "url" : "uri",
  ...
  "version" : "2027.0.0-template.0.13.2",
  "name" : "ExamplePatient",
  ...
  "status" : "active",
  "experimental" : false,
  "date" : "2026-08-31T15:04:56+00:00",
  "publisher" : "NUM-DIZ",
  "_publisher" : {
    "extension" : [{
      "extension" : [{
