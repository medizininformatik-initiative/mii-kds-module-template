# mii-param-template-manifest - MII Implementation Guide Module Template v2027.0.0-template.0.13.2
...
```json
{
  ...
  {
    "name" : "default-canonical-version",
    "valueCanonical" : "https://www.medizininformatik-initiative.de/fhir/modul-template/StructureDefinition/example-patient|2027.0.0-template.0.13.2"
  },
  {
    "name" : "default-canonical-version",
