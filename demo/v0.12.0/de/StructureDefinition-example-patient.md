# Example Patient — template starter - MII Implementation Guide Module Template v2027.0.0-template.0.12.0
...
| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/modul-template/StructureDefinition/example-patient | *Version*:2027.0.0-template.0.12.0 |
...
```json
{
  ...
  "meta" : {
    ...
    },
    {
      ...
      {
        "url" : "version",
        "valueString" : "2027.0.0-template.0.12.0"
      },
      {
        "url" : "uri",
  ...
  "version" : "2027.0.0-template.0.12.0",
  "name" : "ExamplePatient",
  ...
  "status" : "active",
  "experimental" : false,
  "date" : "2026-08-28T05:44:48+00:00",
  "publisher" : "NUM-DIZ",
  "_publisher" : {
    "extension" : [{
      "extension" : [{
