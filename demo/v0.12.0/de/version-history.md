# Versionierung - MII Implementation Guide Module Template v2027.0.0-template.0.12.0
...
* Format **`JJJJ.MINOR.PATCH[-label]`** — die aktuelle Version ist `2027.0.0-template.0.12.0`;
