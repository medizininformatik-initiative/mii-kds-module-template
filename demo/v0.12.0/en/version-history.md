# Versioning - MII Implementation Guide Module Template v2027.0.0-template.0.12.0
...
* format **`YYYY.MINOR.PATCH[-label]`** — the current version is `2027.0.0-template.0.12.0`;
