# mii-param-template-manifest - MII Implementation Guide Module Template v2027.0.0-template.0.12.0
...
```json
{
  ...
  {
    "name" : "default-canonical-version",
    "valueCanonical" : "https://www.medizininformatik-initiative.de/fhir/modul-template/StructureDefinition/example-patient|2027.0.0-template.0.12.0"
  },
  {
    "name" : "default-canonical-version",
